    ...
    public void fireAction(Player player, Location location, ConfigurationSection configuration) {
        ...
        for (LivingEntity livingEntity : livingEntities) {
            ...
            if (compatibilityManager.isExtensionEnabled(GriefPreventionExtension.class)
                    ...
                    .canUseWeapons(player, livingEntity.getLocation())) continue;
            ...
            if (compatibilityManager.isExtensionEnabled(WorldGuardExtension.class)
                    ...
                    WorldGuardExtension.GunshellFlag.GUNSHELL_USE_WEAPONS, false)) continue;
            ...
            if (livingEntity instanceof Player) {
                ...
                if (playerTarget.getGameMode() == GameMode.SPECTATOR
                        || playerTarget.getGameMode() == GameMode.CREATIVE) continue;
